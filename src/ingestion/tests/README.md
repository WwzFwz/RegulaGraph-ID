...
menolak binding kedua dalam proses, mem-parsing PDF sintetis, dan memeriksa span serta manifest. Set `REGULAGRAPH_PDFIUM_LIBRARY` ke file library
...
Native parser integration test aktif untuk PDF teks sintetis, malformed input, tamper hash, dan ownership binding global. OCR, crash
isolation, corpus batch, source mapping gold, serta publication belum diuji di folder ini.
