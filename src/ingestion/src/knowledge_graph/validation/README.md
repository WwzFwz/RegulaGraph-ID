...
| --- | --- | --- |
| [checks.rs](checks.rs) | Validate graph batch references, types, qualifiers, source spans and completeness before publication; emit structured issues. | Inject dangling canonical/version/support refs and conflicting scope; separate deterministic validity from semantic truth. |
