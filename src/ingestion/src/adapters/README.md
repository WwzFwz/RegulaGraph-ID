...
[native_inference.rs](native_inference.rs) menyediakan batch embedding async terpin untuk indexing; [native_inference_tests.rs](native_inference_tests.rs) memeriksa drift, duplicate/missing results, scalar budget, serta endpoint C++ opt-in. Tidak memuat model di Rust dan tidak memublikasikan indeks.
