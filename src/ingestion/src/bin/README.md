...
`regulagraph-worker.rs` melayani gRPC pada loopback, memuat PDFium sekali dengan hash terverifikasi, membatasi message/concurrency/status registry, dan melakukan shutdown terkontrol. Deployment lintas host wajib menambahkan termination TLS terautentikasi sebelum listener boleh diperluas dari loopback.
