...
//! persistence DocumentBatch C01, artifact store lokal, incremental change planner, dan selector timeline
//! ketentuan aktif sebagai library; executable worker, event extraction, graph, serta indexing belum aktif.
