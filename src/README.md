...
[deployment](../deployment/README.md) mengatur packaging dan wiring deployment. Lokasi dalam src tidak berarti semua source harus disalin ke image runtime: build menghasilkan binary, library, serta binding yang relevan. Rust kini memiliki boundary parser PDFium aktif di library ingestion, sedangkan bagian lainnya dan C++ masih bertahap; executable worker dan layanan inference belum aktif.
