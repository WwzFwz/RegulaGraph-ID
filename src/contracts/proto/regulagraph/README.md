# src/contracts/proto/regulagraph

Namespace schema lintas runtime milik proyek. Dokumen ini mendefinisikan superset tanggung jawab folder dan kontrak integrasi anaknya.
...
Anak mengikuti versi paket dan aturan kompatibilitas; jangan menyamakan versi schema wire dengan versi regulasi.
...
Paket v1 menambahkan field resolusi kontekstual secara aditif. Gateway/workflow berada di server; folder ini tetap pemilik kontrak wire.
