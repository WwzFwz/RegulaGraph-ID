...
// change validation. No backend I/O occurs here. Construction is O(batch
// records + references), checks are O(record version filters); profile build
// RSS and per-record p95 under configs/benchmark-targets.yaml.
package domain
