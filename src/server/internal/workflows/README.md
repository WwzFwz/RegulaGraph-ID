...
| [ingest.go](ingest.go), [parse.go](parse.go), dan [bind.go](bind.go) | Pertahankan dispatch/retry durable PARSE/STRUCTURE/BIND/CHUNK; tambahkan lease heartbeat, EXTRACT, dan publication coordinator. | Injeksi crash di register/dependency/checkpoint/completion, uji cancellation dan bounded-capacity dispatch dengan PostgreSQL nyata, lalu ukur queue/call p95/p99. |
