...
| --- | --- | --- |
| [main.go](main.go) | Bootstrap config, lifecycle and API dependencies when A01/O01 endpoints exist; return explicit readiness failures. | Test startup rollback, signals and graceful drain; no model load or connection at import. |
