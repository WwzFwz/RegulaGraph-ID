...
Layanan C++ belum ada; scaffold saat ini hanya static library. Rust belum memiliki executable worker. Desain menambahkan entry point dan transport pada tahap implementasi di folder pemilik yang ada, tanpa memindahkan algoritma ke Python. Tidak ada RPC terpisah untuk fusion, filtering, context builder, atau pemeriksaan citation.
