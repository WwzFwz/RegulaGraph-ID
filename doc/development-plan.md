...
Kerja berikutnya berjalan pada tiga jalur yang saling memasok bukti: tuntaskan D01 inventory/audit sumber, bangun G01 gold structure/temporal, dan lanjutkan handoff PARSE menuju STRUCTURE dengan identitas edisi/regulasi/ketentuan eksplisit agar STRUCTURE dan CHUNK tidak membuat ID sintetis. Scheduler perlu menambah retry availability/max-attempt durable dan lease heartbeat sebelum batch panjang. Setelah itu lanjutkan extraction change-event, canonical registry, OCR per halaman, tabel, dan exception linking. M01 tetap memilih OCR, embedding, reranker, tokenizer, serta backend native berdasarkan kualitas, latency, throughput, dan memori.
