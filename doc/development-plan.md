...
Kerja berikutnya berjalan pada tiga jalur yang saling memasok bukti: tuntaskan D01 inventory/audit sumber, bangun G01 gold structure/temporal, dan hubungkan scheduler durable Go ke worker PARSE. Kontrak batch berikutnya perlu membawa identitas edisi/regulasi/ketentuan agar STRUCTURE dan CHUNK tidak membuat ID sintetis. Setelah itu lanjutkan extraction change-event, canonical registry, OCR per halaman, tabel, dan exception linking. M01 tetap memilih OCR, embedding, reranker, tokenizer, serta backend native berdasarkan kualitas, latency, throughput, dan memori.
