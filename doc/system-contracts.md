...
| TextArtifact | text_artifact_id, source_blob_id, parser_manifest, raw_text_ref, normalized_text_ref, mapping_ref, page_results | Rust; mapping dapat many-to-many, tidak mengasumsikan offset linear |
