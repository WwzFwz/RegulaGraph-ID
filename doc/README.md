...
[verification-report-semantic-extract.md](verification-report-semantic-extract.md) merekam audit adversarial boundary model EXTRACT, sedangkan [verification-report-i01-durable-extract.md](verification-report-i01-durable-extract.md) merekam claim, commit, source-evidence validation, dan recovery coordinator EXTRACT.
