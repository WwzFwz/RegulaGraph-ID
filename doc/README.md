...
Collector PDF, kontrak/validator C01, evaluator offline E01, dan fondasi control-plane storage/publication
S01 sudah aktif. Pipeline parsing/graph/retrieval, mutasi backend Qdrant/Neo4j, layanan model, gold dataset,
serta acceptance run produksi belum aktif. Status anak dijelaskan pada header masing-masing; test correctness
S01 maupun evaluator sintetis tidak membuktikan target kualitas atau latency.
